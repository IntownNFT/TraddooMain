...
const Newsletter = () => {
  ...
  return (
    <div className="py-24 px-6 bg-dark-grey border border-light-grey rounded-lg space-y-4 w-full max-w-[1120px] mx-auto">
      ...
      <form className="relative flex flex-col gap-2 w-full max-w-lg mx-auto" onSubmit={handleSubmit}>
        <Input
          type="email"
          label="Email Address"
          value={email}
          ...
          className={`pr-20 bg-transparent px-3 !h-11 !text-lg font-raleway font-semibold text-white rounded-md border-2 !border-light-grey focus:!border-blue placeholder:!opacity-100 placeholder:!text-light-grey !transition-none ${err===""?"":"!border-blue"}`}
          containerProps={{
            className: "min-w-0",
          }}
        ...
        { success === "" || <label className="text-xs pl-2 text-green-500">{success}</label>}
        <Button
          placeholder={""}
          size="sm"
          type="submit"

...
const InstrumentsTable = ()=>{
  ...
  export const FAQsData = [
    ...
    },
    {
      ...
      Answer:
        <>Once you have an active Traddoo account you can log into your dashboard with the following URL <a href="/" className="text-blue">www.traddoo.com</a> . Simply enter the email registered with the account and your password and log in.</>,
    },
    {
    ...
    },
    {
      ...
      Answer:
        "Congratulations on passing Phase 2. Your Traddoo Funded Account should be processed in no longer than 48 hours. However, before you receive your Funded Account our team will evaluate your performance. To get your Funded Account granted, you must have met the below requirements: ● Met the profit target of 8% ● Traded a minimum of 5 trading days ● Closed all active trades on the phase 2 account ● Have not violated any of our rules & met our consistency target of 60% Once we are happy that you've met all these requirements we will grant you your Funded Account with the capital initially chosen at the beginning. Important: Once you are a Traddoo trader you will trade on a live account and therefore will be required to provide the required Identity (KYC) documents.",
    },
    {
    ...
    },
    {
      ...
      Answer:
        <>Taking part in one of our challenges couldn't be easier. Simply sign up and purchase a challenge direct from your dashboard. We accept both all major cards and crypto payments, you can choose from the following cryptocurrency payment methods:<br/><br/>1. Bitcoin (BTC) <br/>2. Ethereum (ETH) <br/>3. Litecoin (LTC) <br/>4. Dogecoin (DOGE) <br/>5. Tether (USDT-ERC20) <br/>6. USD Coin (USDC -ERC20) <br/><br/>Once you have made your purchase (and it has been verified on the blockchain in case of crypto payment), you will receive your challenge account credentials via email. You are now ready to start your challenge. Important Note: In order to use ETH (ERC-20), USDT (ERC-20), or USDC (ERC-20) you will need to use the ERC-20 standard.</>,
    },{
      Question: "What instruments are available?",
      Answer: (
        <> With Traddoo you can trade a variety of instruments, from currencies to crypto to commodities.<br/>The table below is a comprehensive list of all instruments available Note: This list is effective as of 15/11/2023, and it may change without notice. However, we will endeavor to communicate any changes promptly. <br/>Search:
        <InstrumentsTable />
        </>
      )
    },
    ...
    {
      Question:
        "How Can I Reset My Funded Account Challenge Trading Password",
      Answer:
    ...
    },
    {
      ...
      Answer:
        "At Traddoo, we provide a variety of account sizes and prices to accommodate traders of different backgrounds, ensuring an accessible platform for all. Funded Challenge Offer: Start a profitable career with our $25,000 Funded Account Challenge $25,000 Challenge Offer: - Price: $249 - Refundable Fee: $249* Grow your skills as a trader without risking your capital with our $50,000 Funded Account Challenge. $50,000 Challenge Offer: - Price: $349 - Refundable Fee: $349* Show off your pro trading tactics and get funded with our $100,000 Funded Account Challenge. $100,00 Challenge Offer: - Price: $549 - Refundable Fee: $549* Size this opportunity to advance your trading career with our $150,000 Funded Account Challenge. $150,000 Challenge Offer: - Price: $749 - Refundable Fee: $749* Unlock the door to success in trading with our $200,000 Funded Account Challenge. $200,000 Challenge Offer: - Price: $989 - Refundable Fee: $989* * The fee is refunded upon successful completion of Phase 2. Join us today and seize the chance to amplify your trading potential. Discover the perfect match among our diverse Funded Account Challenges and chart your course toward financial success and trading excellence.",
    },
    {
    ...
    },
    {
      ...
      <p>
          ...
          who have tried and tested strategies can get funded faster. This Account
          type offers several add-ons for further customization:
        </p>
        <ul>
